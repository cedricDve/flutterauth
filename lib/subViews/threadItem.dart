                ...
                child: Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(Icons.favorite,size: 18,color: widget.myData.myLikeList != null && widget.myData.myLikeList.contains(widget.data['postID']) ? Colors.blue[900] : Colors.black),
                          Padding(
                            padding: const EdgeInsets.only(left:8.0),
                            child: Text('Nice ( ${widget.isFromThread ? widget.data['postLikeCount'] : _likeCount} )',
                              style: TextStyle(fontSize: 16,
